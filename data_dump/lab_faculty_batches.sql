...
LOCK TABLES `faculty_batches` WRITE;
/*!40000 ALTER TABLE `faculty_batches` DISABLE KEYS */;
INSERT INTO `faculty_batches` VALUES (2,'B1'),(2,'B2');
/*!40000 ALTER TABLE `faculty_batches` ENABLE KEYS */;
UNLOCK TABLES;
